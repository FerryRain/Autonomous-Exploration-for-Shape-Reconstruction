...
def run_exploration(robot: Real_Robot):
    ...
    gpis_res = 100
    gpis_grid_count = 6
    gpis_store_path = "../../Results/RealExp_3/Real_exp_3_sphere_"
    ...
    egpis = init_normal_HER_GPIS_uncertainty(temp_min, temp_max, points_num, intervals, res=gpis_res,
    ...
    # Simulate physics
    while True and egpis.time_step <= 300:
