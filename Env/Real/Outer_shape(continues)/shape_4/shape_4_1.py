...
def run_exploration(robot: Real_Robot):
    ...
    gpis_res = 100
    gpis_grid_count = 6
    gpis_store_path = "../../../Results/Outer/object_4_continue/outer_shape_4_1_"
    ...
    while True:
        ...
        if gpis.time_step != 0 and gpis.time_step % 100 == 0:
