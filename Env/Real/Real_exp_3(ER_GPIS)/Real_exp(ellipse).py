...
def run_exploration(robot: Real_Robot):
    ...
    gpis_res = 100
    gpis_grid_count = 6
    gpis_store_path = "../../Results/RealExp_3/Real_exp_3_ellipse_"
    ...
    while True and er_gpis.time_step <= 120:
        ...
        if er_gpis.time_step == 70  or er_gpis.time_step == 100:
        ...
        if er_gpis.time_step % 10 == 0 and er_gpis.time_step > 100:
