...
def run_exploration(robot: Real_Robot):
    ...
    gpis_res = 50
    gpis_grid_count = 4
    gpis_store_path = "../../Results/ablation/Diress/without_global/Diress_without_global_2_"
    ...
    while gpis.time_step < 100:
        ...
        if gpis.time_step == 10  or gpis.time_step == 20:
            ...
            while True:
                ...
                arm.move_to(next_position.numpy())
                step += 1
        if gpis.time_step % 10 == 0 and gpis.time_step >= 20:
